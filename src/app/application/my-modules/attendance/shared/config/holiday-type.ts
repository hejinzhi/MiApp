...
export class HolidayType {
  ...
  attendanceMonthType =[
    ...
    { name: '应出勤天数', type: 'NEED_DAY' },
    { name: '实出勤天数', type: 'PRESENT_DAY' },
    ...
    { name: '全月请假天数', type: 'TOT_LEAVE' },
    { name: '迟到早退次数', type: 'LATE' },
    { name: '迟到早退时间', type: 'LATE_TIME' },
    { name: '折现时数', type: 'PAY_HOURS' },
    ...
    { name: '出勤天数', type: 'TOT_DUTY' },
    { name: '加班总时数', type: 'OVERTIME1_133' },
    { name: '周六加班时数', type: 'SAT_DAYS' },
    { name: '休息日加班', type: 'OVERTIME2_2' },
    { name: '平时加班时数', type: 'OVERTIME2_133' },
